...
// Package security provides security-related utilities for the Swit microservice framework.
// It includes OAuth2/OIDC authentication, JWT token validation, and other security features.
package security
