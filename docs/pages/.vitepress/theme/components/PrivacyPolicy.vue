      ...
      <div v-if="showCookieModal" class="cookie-modal" @click="closeCookieModal">
        <div class="modal-content" @click.stop>
          ...
          <div class="modal-body">
            ...
            <div class="cookie-category">
              <div class="category-header">
                <h4>{{ isZh ? '分析 Cookie' : 'Analytics Cookies' }}</h4>
              ...
              <p class="category-description">
                {{ isZh 
                  ? '这些 Cookie 帮助我们了解访问者如何与网站互动，通过匿名收集和报告信息。这些信息帮助我们改进网站的功能和内容。'
                  : 'These cookies help us understand how visitors interact with the website by collecting and reporting information anonymously. This information helps us improve the functionality and content of our website.'
                }}
              </p>
              <div class="cookie-details">
                <details>
                  ...
                  <ul>
                    <li>Google Analytics: {{ isZh ? '网站流量分析' : 'Website traffic analysis' }}</li>
                    <li>Performance Monitoring: {{ isZh ? '页面性能监控' : 'Page performance monitoring' }}</li>
                  </ul>
                </details>
              </div>
            </div>
        ...
        <div class="modal-content large" @click.stop>
          ...
          <div class="modal-body privacy-content">
            ...
            <div class="privacy-section">
              ...
              <p>
                {{ isZh 
                  ? '我们不会出售、交易或转让您的个人信息给第三方，除非：(a) 获得您的明确同意；(b) 法律要求；(c) 保护我们的权利和安全；(d) 与受信任的服务提供商共享（如 Google Analytics），这些服务提供商有义务保护您的信息。'
                  : 'We do not sell, trade, or transfer your personal information to third parties unless: (a) We have your explicit consent; (b) Required by law; (c) To protect our rights and security; (d) Shared with trusted service providers (such as Google Analytics) who are obligated to protect your information.'
                }}
              </p>
            </div>
            ...
            <div class="privacy-section">
              ...
              <p>
                {{ isZh 
                  ? '我们使用 Cookie 来改善您的体验。您可以通过浏览器设置控制 Cookie，但禁用某些 Cookie 可能会影响网站功能。我们使用的 Cookie 类型包括：(a) 必要 Cookie：网站正常运行所必需；(b) 分析 Cookie：帮助我们了解网站使用情况；(c) 功能 Cookie：记住您的偏好设置。'
                  : 'We use cookies to improve your experience. You can control cookies through your browser settings, but disabling certain cookies may affect website functionality. The types of cookies we use include: (a) Necessary cookies: Essential for proper website operation; (b) Analytics cookies: Help us understand website usage; (c) Functional cookies: Remember your preference settings.'
                }}
              </p>
            </div>
...
function clearAnalyticsCookies() {
  // 清除 Google Analytics Cookie
  const analyticsCookies = ['_ga', '_ga_*', '_gid', '_gat', '_gat_*']
