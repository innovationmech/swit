...
// Package main demonstrates OAuth2/OIDC authentication using the Swit framework.
// This example shows how to:
// - Configure OAuth2 client with Keycloak
// - Implement authorization code flow
// - Use JWT token validation
// - Protect endpoints with OAuth2 middleware
